...
public static class PhoneUsage
{
        ...
        IEventStore store, string host, DateTimeOffset from, DateTimeOffset to, CancellationToken ct = default)
    {
        ...
        foreach (var e in events)
        {
            ...
            // săptămâna dinainte, și în cea de după — același import, în trei săptămâni.
    ...
    /// comercial complet („MemeBox: Funny Pics &amp; GIFs"), iar de la un import la altul
    ...
    public static object Summarize(IReadOnlyList<PhoneWeek> weeks, TrackerConfig cfg)
    {
        ...
        foreach (var w in weeks)
        {
            foreach (var (name, minutes) in w.Apps)
            {
                ...
                // importuri, „MemeBox" și „MemeBox: Funny Pics & GIFs" sunt aceeași aplicație și
                ...
                // ore de „Safari · neutru" care erau, de fapt, un singur site.
