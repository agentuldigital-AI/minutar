...
public sealed class ReportService
{
    ...
    /// Over a full day those crumbs add up to real time. The gap belongs to the
    ...
    /// On a busy day the seams alone are worth over an hour, all active→active. Real pauses are
