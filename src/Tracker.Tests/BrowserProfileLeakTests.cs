...
/// how a Bookings tab in a plain Chrome profile ended up as "Client B · Productiv" (2026-08-04).
/// </summary>
public sealed class BrowserProfileLeakTests
{
    ...
    {
        // in practice: the bar was already clean, but the heartbeat still landed in the
    ...
    public void ForegroundWindowWithNoMatchingTab_GetsNoBrowserState()
    {
        ...
        var best = store.BestFor("Bookings - Google Chrome", "chrome.exe", Fresh);
    ...
    public void CompetingProfiles_TheOneMatchingTheWindowTitleWins()
    {
        ...
        store.Update(Hb("General", "Bookings", "https://bookings.example/app", focused: false));
