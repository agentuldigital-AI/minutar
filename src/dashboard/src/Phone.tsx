...
- "name" = numele SCURT al aplicației. Taie sufixul descriptiv de după „:" sau „-" — scrie
  „MemeBox", nu „MemeBox: Funny Pics & GIFs". Numele trebuie să fie identic de la o săptămână
...
const SUGGESTED: Record<string, string> = {
  "memebox": "unproductive", tiktok: "unproductive", facebook: "unproductive",
  ...
  paypago: "productive", "mail plus": "productive",
};
 ...
 * aplicațiilor din Screen Time nu e egală cu totalul afișat de Apple (în practică
          ...
          <>
            ...
            <div className="tiles phone-tiles">
              {([
                ...
                //
                // Am crezut întâi că sunt aplicații tăiate de „Show More". Nu sunt: pe săptămâni
                // cu liste de lungimi foarte diferite golul rămâne aproape la fel, iar
                // raportat la numărul de ridicări dă mereu aceleași câteva zeci de secunde.
                ...
                // notificări. Coada tăiată și navigarea nedetaliată explică o parte din el.
